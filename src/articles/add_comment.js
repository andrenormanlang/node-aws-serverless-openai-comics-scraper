...
async function updateUserNotifications(
  ...
  parentUserId,
  username,
  notificationType // Pass notificationType as dynamic from app side to differenciate notification
) {
  /*
  ...
  */
  ...
  const params = {
    ...
    ExpressionAttributeNames: {
      "#comments": notificationType, // add notificationType to differenciate
    },
